...
test "sseNP0F" {
    const content: []const u8 =
        ...
        \\movups xmm0, [rip+0x0]
        \\movups [rip+0x0],xmm0
        \\movlps xmm0, p64 [rip+0x0]
        \\movlps p64 [rip+0x0],xmm0
        \\unpcklps xmm0, [rip+0x0]
        \\unpckhps xmm0, [rip+0x0]
        \\movhps xmm0, p64 [rip+0x0]
        \\movhps p64 [rip+0x0],xmm0
        \\movaps xmm0, [rip+0x0]
        \\movaps [rip+0x0],xmm0
        \\cvtpi2ps xmm0, p64 [rip+0x0]
        \\movntps [rip+0x0],xmm0
        \\ucomiss xmm0, p32 [rip+0x0]
        \\comiss xmm0, p32 [rip+0x0]
        \\movmskps eax,xmm0
        \\sqrtps xmm0, [rip+0x0]
        \\rsqrtps xmm0, [rip+0x0]
        \\rcpps xmm0, [rip+0x0]
        \\andps xmm0, [rip+0x0]
        \\andnps xmm0, [rip+0x0]
        \\orps xmm0, [rip+0x0]
        ...
        \\addps xmm0, [rip+0x0]
        \\mulps xmm0, [rip+0x0]
        \\cvtps2pd xmm0, p64 [rip+0x0]
        \\cvtdq2ps xmm0, [rip+0x0]
        \\subps xmm0, [rip+0x0]
        \\minps xmm0, [rip+0x0]
        \\divps xmm0, [rip+0x0]
        \\maxps xmm0, [rip+0x0]
        \\movnti p32 [rip+0x0],eax
        \\
    ;
    ...
    const expected: []const u8 = &.{  };
...
test "branching" {
    const content: []const u8 =
        ...
        \\    jmp .l9
        \\    div rdx
        \\    mov p64 [edi + eax*8 + 0x11223344], 0x55667788
        \\    mov p64 [edi + eax*8 + 0x11223344], 0x55667788
        \\    mov p64 [edi + eax*8 + 0x11223344], 0x55667788
        \\    mov p64 [edi + eax*8 + label], 0x55667788
        \\    jz .l0
        \\    mov p64 [edi + eax*8 + 0x11223344], 0x55667788
        \\    mov p64 [edi + eax*8 + 0x11223344], 0x55667788
        \\    mov p64 [edi + eax*8 + 0x11223344], 0x55667788
    ...
    const expected: []const u8 = &.{  };
